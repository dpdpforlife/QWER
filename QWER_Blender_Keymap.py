 ...
 ("3D View",
  ...
  {"items":
   [("transform.snap_utilities_rotate",
    ...
    ("view3d.jkl_controls", {"type": 'J', "value": 'PRESS', "alt": True}, None),
    ("view3d.jkl_controls", {"type": 'J', "value": 'PRESS'}, None),
    ("view3d.jkl_controls", {"type": 'K', "value": 'PRESS'}, None),
    ("view3d.jkl_controls", {"type": 'L', "value": 'PRESS'}, None),
    ("view3d.jkl_controls", {"type": 'L', "value": 'PRESS', "alt": True}, None),
    ("space_data.show_gizmo_object_translate", {"type": 'ACCENT_GRAVE', "value": 'PRESS', "shift": True, "ctrl": True, "alt": True}, None),
